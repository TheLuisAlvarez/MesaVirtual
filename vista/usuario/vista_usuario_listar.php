        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_con1" placeholder="Ingrese contrase&ntilde;a"><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Repita la contrase&ntilde;a</label>
                    <input type="text" class="form-control" id="txt_con2" placeholder="Repita contrase&ntilde;a"><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Rol</label>
